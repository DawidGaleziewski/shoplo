...
<!-- header_7_1566327099021 -->
{snippet file="search_widget"}
<header class="shb-header-7">
	<div class="container">
		<div class="columns unsticky-after-this shb-header-top is-vertical-center is-desktop is-vertical-marginless">
			...
			<div class="column shb-right-header align-right is-hidden-mobile">
	...
	<div class="shb-navbar {if $settings->fixed_header == 1}sticky-bar sticky-after-this{/if}">
		<div class="container shb-border-top">
			{snippet file="main_nav"}
		</div>
	</div>
</header>
<!-- END header_7_1566327099021 -->
