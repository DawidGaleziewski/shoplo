...
<!-- banner_7_1566327052945 -->
<div id="{$settings->banner_7_1566327052945->name}" class="shb-banner-7 shb-section-slider shb-banner-without-top-margin" data-banner-handler="{$settings->banner_7_1566327052945->name}">
    <div class="container is-full">
        {if $settings->banner_7_1566327052945->slides|count > 0 && $settings->isBannerVisible({$settings->banner_7_1566327052945->name})}
            <div class="shb-slider-loader shb-dots-loader">
                <div class="shb-dot"></div>
                <div class="shb-dot"></div>
                <div class="shb-dot"></div>
            </div>
            <div class="shb-slider-wrapper" data-autoplay="{$settings->banner_7_1566327052945->settings->autoplay->value}" data-duration="{$settings->banner_7_1566327052945->settings->duration->value}" data-show-arrows="{$settings->banner_7_1566327052945->settings->show_arrows->value}" data-animation="{$settings->banner_7_1566327052945->settings->animation_effect->value}">
                <div class="shb-slider">
                    <div class="shb-slides">
                        {foreach from=$settings->banner_7_1566327052945->slides item="slide"}
        ...
        {else}
            <div class="shb-blankslate-banner">
                <figure{if !$settings->isBannerVisible({$settings->banner_7_1566327052945->name})} data-slide-handler="1"{/if}>
...
<!-- END banner_7_1566327052945 -->




<!-- productgrid_col3_4_1566326155697 -->
{snippet
  file="home_grid"
...
<!-- END productgrid_col3_4_1566326155697 -->

<!-- newsletter_6_1566326161886 -->
<div class="shb-newsletter-widget-6">
	<div class="container shb-newsletter-background">
		...
		<div class="shb-newsletter-form column is-offset-2-tablet is-8-tablet is-offset-3-desktop is-6-desktop is-vertical-paddingless">
			<form action="{reverse_url name=shop_newsletter}" method="post">
				<div class="shb-form-inline align-center">
					...
					<button type="submit"
							class="shb-btn shb-btn-small shb-btn-light">{trans}store_theme_translations.newsletter_button{/trans}</button>
				</div>
...
<!-- END newsletter_6_1566326161886 -->
