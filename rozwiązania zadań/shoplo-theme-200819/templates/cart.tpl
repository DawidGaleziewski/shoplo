<!-- ### CART ### --><!-- cart_3_1566322516186 -->
<div class="container">
    <div class="shb-cart-3">
                ...
                <div class="columns">
                    <div class="column is-7-tablet is-8-desktop">
                        <div class="is-hidden-mobile shb-table-head">
                            <div class="columns">
                                <div class="column is-6 is-vertical-paddingless shb-cart-head-product"><span
                                            class="shb-text">{trans}store_theme_translations.cart_head_product{/trans}</span></div>
                                <div class="column is-6 is-paddingless">
                                    <div class="columns is-marginless">
                                        <div class="column is-5 is-vertical-paddingless align-center shb-quantity"><span
                                                    class="shb-text">{trans}store_theme_translations.cart_head_quantity{/trans}</span>
                                        </div>
                                        <div class="column is-5 is-paddingless align-right"><span
                        ...
                        <ol cart-list class="shb-cart-list">
                            <li cart-product class="shb-cart-item shb-item-template" data-variant-id=""
                                ...
                                <div class="columns is-desktop">
                                    <div class="column is-6-desktop is-vertical-center shb-item-info">
                                        <a item-image
                                           href=""
                                    ...
                                    <div class="column is-6-desktop is-paddingless is-vertical-center">
                                        <div class="columns is-mobile is-marginless shb-item-actions">
                                            <div class="column is-6 is-vertical-center align-flex-center shb-product-qty shb-item-quantity-wrapper">
                                                <a decrease-quantity
                                            ...
                                            <div class="column is-mobile is-5 shb-product-price">
                                                <span product-price
                    ...
                    <div class="column is-offset-1 is-4-tablet is-3-desktop">
